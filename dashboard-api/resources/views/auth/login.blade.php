...
<x-guest-layout>
    <!-- Session Status -->
    <h1 class="text-xl my-8 text-center font-medium">{{__('Login')}}</h1>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            <a href="{{ route('register') }}" class="mr-4 font-semibold text-gray-600 hover:text-violet-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-violet-500">Register</a>
