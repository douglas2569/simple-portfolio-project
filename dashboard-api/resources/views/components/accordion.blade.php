...
<div id="accordion-collapse" data-accordion="collapse" class="w-[600px] text-sm">
    ...
    <div class="mt-4">
        <h2 id="accordion-collapse-heading-1">
            <span type="button" class="bg-violet-50 cursor-pointer flex items-baseline justify-between w-full p-5 font-medium rtl:text-right text-gray-900 border border-b-0 border-gray-100 rounded-t-xl focus:ring-4 focus:ring-violet-200 dark:focus:ring-violet-800 dark:border-gray-700 dark:text-gray-400 hover:bg-violet-200 dark:hover:bg-violet-800 gap-3" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
