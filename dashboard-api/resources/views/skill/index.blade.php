        ...
        @if(count($technologies) > 0)
            ...
            @csrf
                ...
                <div>
                    ...
                    <ul class="grid sm:grid-cols-5 text-base font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        @foreach($technologies as $technology)
                            <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                <div class="flex items-center ps-3">
                                    ...
                                    <label for="{{$technology->name}}-checkbox" class="w-full py-3 ms-2 text-base font-medium text-gray-900 dark:text-gray-300">{{$technology->name}}</label>
                                </div>
                            </li>
                        @endforeach
                    </ul>
